    ...
    return(
        <>
            <SafeAreaProvider>
                ...
                <StatusBar animated={true} backgroundColor={'#fbfbfb'} barStyle={'dark-content'} showHideTransition={'fade'} hidden={false} />
                        ...
                        <View style={HomeStyle.HomeViewSubFlex}>
                            ...
                            <View style={HomeStyle.HomeViewCardAction}>
                                <Link style={HomeStyle.HomeViewCardActionLink} href={'/transactions'}>
                                    <Text style={HomeStyle.HomeViewCardActionCap}>Transactions History</Text>
                                </Link>
                        ...
                        <View style={HomeStyle.HomeViewFlex}>
                            ...
                            <View style={HomeStyle.HomeViewDebitCard}>
                                ...
                                <View style={HomeStyle.HomeViewDebitCardCol}>
                                    <Text style={HomeStyle.HomeViewDebitCardColCap}>Debit Card</Text>
                                    <Text style={HomeStyle.HomeViewDebitCardColSCap}>1234 1234 4567 34567</Text>
                                </View>
                                <View style={HomeStyle.HomeViewDebitCardRow_Div}></View>
                                <View style={HomeStyle.HomeViewDebitCardRow}>
                                    <View style={HomeStyle.HomeViewDebitCardRowCol}>
                                        <Text style={HomeStyle.HomeViewDebitCardRowCap}>Card Holder Name</Text>
                                        <Text style={HomeStyle.HomeViewDebitCardRowSCap}>John Doe</Text>
                                    </View>
                                    <View style={HomeStyle.HomeViewDebitCardRowCol_}>
                                        <Text style={HomeStyle.HomeViewDebitCardRowCap}>Exp. Date</Text>
                                        <Text style={HomeStyle.HomeViewDebitCardRowSCap}>06/25</Text>
                                    </View>
                                </View>
                            </View>
