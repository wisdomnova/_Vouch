      ...
      <SafeAreaView style={SplashStyle.SplashSafeView}>
        <View style={SplashStyle.SplashView}>
          ...
          <View style={SplashStyle.SplashTextCov}>
            <Text style={SplashStyle.SplashTextCovCap}>
          ...
          <View style={SplashStyle.SplashHistoryOvflw}>
              ...
              <View style={SplashStyle.SplashHistoryCard}>
                <View style={SplashStyle.SplashHistoryCardLt}>
                  ...
                  <View style={SplashStyle.SplashHistoryCardCol}>
                    <Text style={SplashStyle.SplashHistoryCardColCap}>
                      John Doe
                    </Text>
                    <Text style={SplashStyle.SplashHistoryCardColSCap}>
                      5/11/2024 10:57AM
                    </Text>
                  </View>
                </View>
                <View style={SplashStyle.SplashHistoryCardRt}>
                  <Text style={SplashStyle.SplashHistoryCardRtSCap}>
                    Credited
                  </Text>
                  <Text style={SplashStyle.SplashHistoryCardRtCap_G}>
                    ₦2,000
                  </Text>
                </View>
              </View>
            ...
            <Link href={"/transactions"}>
              <View style={SplashStyle.SplashHistoryCard}>
                ...
                <View style={SplashStyle.SplashHistoryCardRt}>
                  <Text style={SplashStyle.SplashHistoryCardRtSCap_R}>
                    Loan
                  </Text>
                  <Text style={SplashStyle.SplashHistoryCardRtCap}>₦4,000</Text>
                  <Text style={SplashStyle.SplashHistoryCardRtSCap_G}>
                    Cleared
                  </Text>
                </View>
              </View>
            ...
            <Link href={"/transactions"}>
              <View style={SplashStyle.SplashHistoryCard}>
                ...
                <View style={SplashStyle.SplashHistoryCardRt}>
                  ...
                  <Text style={SplashStyle.SplashHistoryCardRtCap}>
                    - ₦7,000
                  </Text>
                  <Text style={SplashStyle.SplashHistoryCardRtSCap_R}>
                    Outstanding
